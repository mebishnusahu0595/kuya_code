...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/kuyacode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/kuyacode...\n")
...
console.log("Fetching npm all-time downloads for kuyacode-ai...\n")
const npmDownloads = await fetchNpmDownloads("kuyacode-ai")
