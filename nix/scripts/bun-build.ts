import solidPlugin from "./packages/kuyacode/node_modules/@opentui/solid/scripts/solid-plugin"
import path from "path"
import fs from "fs"

const version = "@VERSION@"
const pkg = path.join(process.cwd(), "packages/kuyacode")
...
const manifestName = "kuyacode-assets.manifest"
...
const result = await Bun.build({
  ...
  compile: {
    ...
    execArgv: ["--user-agent=kuyacode/" + version, "--use-system-ca", "--"],
    windows: {},
  },
})
...
const dest = path.join(pkg, "kuyacode-worker.js")
