...
rustPlatform.buildRustPackage rec {
  ...
  desktopItems = lib.optionals stdenv.isLinux [
    (makeDesktopItem {
      name = "ai.kuyacode.kuyacode";
      desktopName = "KuyaCode";
      comment = "Open source AI coding agent";
      exec = "kuyacode-desktop";
      icon = "kuyacode";
      terminal = false;
      type = "Application";
      categories = [ "Development" "IDE" ];
      startupWMClass = "kuyacode";
    })
  ];
  ...
  preBuild = ''
    ...
    cp ${args.kuyacode}/bin/kuyacode packages/desktop/src-tauri/sidecars/kuyacode-cli-$targetTriple
  ...
  postInstall = lib.optionalString stdenv.isLinux ''
    ...
    cp ../../../packages/desktop/src-tauri/icons/prod/128x128.png $out/share/icons/hicolor/128x128/apps/kuyacode.png

    # Wrap the binary to ensure it finds the libraries
    wrapProgram $out/bin/kuyacode-desktop \
  ...
  meta = with lib; {
    description = "KuyaCode Desktop App";
    homepage = "https://kuyacode.ai";
    license = licenses.mit;
    maintainers = with maintainers; [ ];
    mainProgram = "kuyacode-desktop";
