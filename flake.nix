{
  description = "KuyaCode development flake";
  ...
  outputs =
    ...
    let
      ...
      packageJson = builtins.fromJSON (builtins.readFile ./packages/kuyacode/package.json);
      bunTarget = {
      ...
      packages = forEachSystem (
        ...
        let
          ...
          desktopPkg = mkDesktop {
            ...
            kuyacode = kuyacodePkg;
          };
        in
        {
          default = self.packages.${system}.kuyacode;
          kuyacode = kuyacodePkg;
          desktop = desktopPkg;
        }
      );
