...
export default function Enterprise() {
  ...
  return (
    <main data-page="enterprise">
      <Title>KuyaCode | Enterprise solutions for your organisation</Title>
      <Link rel="canonical" href={`${config.baseUrl}/enterprise`} />
      <Meta name="description" content="Contact KuyaCode for enterprise solutions" />
      <div data-component="container">
        ...
        <div data-component="content">
          <section data-component="enterprise-content">
            <div data-component="enterprise-columns">
              <div data-component="enterprise-column-1">
                ...
                <p>
                  KuyaCode operates securely inside your organization with no data or context stored and no licensing
                ...
                <Show when={false}>
                  <div data-component="testimonial">
                    ...
                    Thanks to KuyaCode, we found a way to create software to track all our assets — even the imaginary
                    ones.
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is KuyaCode Enterprise?">
                  KuyaCode Enterprise is for organizations that want to ensure that their code and data never leaves
                  their infrastructure. It can do this by using a centralized config that integrates with your SSO and
                  internal AI gateway.
                </Faq>
              </li>
              <li>
                <Faq question="How do I get started with KuyaCode Enterprise?">
                  Simply start with an internal trial with your team. KuyaCode by default does not store your code or
              ...
              <li>
                <Faq question="Is my data secure with KuyaCode Enterprise?">
                  Yes. KuyaCode does not store your code or context data. All processing happens locally or through
