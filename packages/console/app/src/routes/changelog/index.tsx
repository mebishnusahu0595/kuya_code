...
const getReleases = query(async () => {
  "use server"
  const response = await fetch("https://api.github.com/repos/anomalyco/kuyacode/releases?per_page=20", {
    headers: {
      Accept: "application/vnd.github.v3+json",
      "User-Agent": "KuyaCode-Console",
    },
    cf: {
      cacheTtl: 60 * 5,
...
export default function Changelog() {
  ...
  return (
    <main data-page="changelog">
      <Title>KuyaCode | Changelog</Title>
      <Link rel="canonical" href={`${config.baseUrl}/changelog`} />
      <Meta name="description" content="KuyaCode release notes and changelog" />
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          <section data-component="changelog-hero">
            <h1>Changelog</h1>
            <p>New updates and improvements to KuyaCode</p>
          </section>
