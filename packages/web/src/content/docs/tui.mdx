---
title: TUI
description: Using the KuyaCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KuyaCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running KuyaCode starts the TUI for the current directory.
...
When using the KuyaCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to KuyaCode. Allows you to select from available providers and add their API keys.
...
Exit KuyaCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your KuyaCode config file.
