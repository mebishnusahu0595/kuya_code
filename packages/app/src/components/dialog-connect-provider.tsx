import type { ProviderAuthAuthorization } from "@kuyacode-ai/sdk/v2/client"
import { Button } from "@kuyacode-ai/ui/button"
import { useDialog } from "@kuyacode-ai/ui/context/dialog"
import { Dialog } from "@kuyacode-ai/ui/dialog"
...
import { List, type ListRef } from "@kuyacode-ai/ui/list"
import { ProviderIcon } from "@kuyacode-ai/ui/provider-icon"
import { Spinner } from "@kuyacode-ai/ui/spinner"
import { TextField } from "@kuyacode-ai/ui/text-field"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "kuyacode"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            KuyaCode Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                          ...
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://kuyacode.ai/zen" tabIndex={-1}>
                              kuyacode.ai/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in KuyaCode.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in KuyaCode.
                        </div>
