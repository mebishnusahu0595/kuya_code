...
import { TooltipKeybind } from "@kuyacode-ai/ui/tooltip"
import { useTheme } from "@kuyacode-ai/ui/theme"
  ...
  return (
    <header class="h-10 shrink-0 bg-background-base flex items-center relative">
      ...
      >
        ...
        <div id="kuyacode-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
        <div class="flex-1 h-full" data-tauri-drag-region />
        <div id="kuyacode-titlebar-right" class="flex items-center gap-3 shrink-0" />
        <Show when={reserve()}>
          <div class="w-[120px] h-full shrink-0" data-tauri-drag-region />
        </Show>
      </div>
      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div id="kuyacode-titlebar-center" class="pointer-events-auto" />
      </div>
    </header>
  )
}
