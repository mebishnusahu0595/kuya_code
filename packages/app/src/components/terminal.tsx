...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@kuyacode-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(async () => {
    ...
    if (window.__KUYACODE__?.serverPassword) {
      url.username = "kuyacode"
      url.password = window.__KUYACODE__?.serverPassword
    }
