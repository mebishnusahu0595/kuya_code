...
import { base64Decode, base64Encode } from "@kuyacode-ai/util/encode"
import { Avatar } from "@kuyacode-ai/ui/avatar"
import { ResizeHandle } from "@kuyacode-ai/ui/resize-handle"
import { Button } from "@kuyacode-ai/ui/button"
import { Icon } from "@kuyacode-ai/ui/icon"
import { IconButton } from "@kuyacode-ai/ui/icon-button"
import { InlineInput } from "@kuyacode-ai/ui/inline-input"
import { Tooltip, TooltipKeybind } from "@kuyacode-ai/ui/tooltip"
import { HoverCard } from "@kuyacode-ai/ui/hover-card"
import { DropdownMenu } from "@kuyacode-ai/ui/dropdown-menu"
import { Collapsible } from "@kuyacode-ai/ui/collapsible"
import { DiffChanges } from "@kuyacode-ai/ui/diff-changes"
import { Spinner } from "@kuyacode-ai/ui/spinner"
import { getFilename } from "@kuyacode-ai/util/path"
import { Session } from "@kuyacode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@kuyacode-ai/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@kuyacode-ai/util/binary"
import { retry } from "@kuyacode-ai/util/retry"

import { useDialog } from "@kuyacode-ai/ui/context/dialog"
import { useTheme, type ColorScheme } from "@kuyacode-ai/ui/theme"
...
export default function Layout(props: ParentProps) {
    ...
    async function pollUpdate() {
      ...
      if (updateAvailable && toastId === undefined) {
        toastId = showToast({
          ...
          description: `A new version of KuyaCode (${version}) is now available to install.`,
          actions: [
            {
  ...
  const ProjectIcon = (props: { project: LocalProject; class?: string; notify?: boolean }): JSX.Element => {
    ...
    const kuyacode = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    return (
      <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
        <div class="size-full rounded overflow-clip">
          <Avatar
            fallback={name()}
            src={props.project.id === kuyacode ? "https://kuyacode.ai/favicon.svg" : props.project.icon?.url}
          ...
          <div class="shrink-0 w-full pt-3 pb-3 flex flex-col items-center gap-2">
            ...
            <Tooltip placement={sidebarProps.mobile ? "bottom" : "right"} value="Help">
              <IconButton
                ...
                variant="ghost"
                size="large"
                onClick={() => platform.openLink("https://kuyacode.ai/desktop-feedback")}
              />
            </Tooltip>
          </div>
        </div>
              ...
              <div class="shrink-0 px-2 py-3 border-t border-border-weak-base">
                <div class="rounded-md bg-background-base shadow-xs-border-base">
                  <div class="p-3 flex flex-col gap-2">
                    ...
                    <div class="text-text-base">KuyaCode includes free models so you can start immediately.</div>
