...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new KuyaCodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the KuyaCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the KuyaCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all KuyaCode instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with KuyaCode.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that KuyaCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by KuyaCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current KuyaCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update KuyaCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all KuyaCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new KuyaCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific KuyaCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current KuyaCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the KuyaCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the KuyaCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the KuyaCode system.
   */
...
export class KuyaCodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<KuyaCodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    KuyaCodeClient.__registry.set(this, args?.key)
  }
