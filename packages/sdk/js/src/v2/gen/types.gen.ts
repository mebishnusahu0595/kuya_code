...
/**
 * Server configuration for kuyacode serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://kuyacode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://kuyacode.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
