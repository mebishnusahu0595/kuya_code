...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kuyacode.git")).toEqual({ owner: "sst", repo: "kuyacode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kuyacode")).toEqual({ owner: "sst", repo: "kuyacode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kuyacode.git")).toEqual({ owner: "sst", repo: "kuyacode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kuyacode")).toEqual({ owner: "sst", repo: "kuyacode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kuyacode.git")).toEqual({ owner: "sst", repo: "kuyacode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kuyacode")).toEqual({ owner: "sst", repo: "kuyacode" })
})
