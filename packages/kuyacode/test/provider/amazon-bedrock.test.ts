...
const mockPlugin = () => ({})
mock.module("kuyacode-copilot-auth", () => ({ default: mockPlugin }))
mock.module("kuyacode-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/kuyacode-gitlab-auth", () => ({ default: mockPlugin }))
