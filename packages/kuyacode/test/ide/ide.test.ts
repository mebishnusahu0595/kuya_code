...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KUYACODE_CALLER", () => {
    process.env["KUYACODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KUYACODE_CALLER", () => {
    process.env["KUYACODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KUYACODE_CALLER", () => {
    process.env["KUYACODE_CALLER"] = "unknown"
