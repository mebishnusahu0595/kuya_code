...
const dir = path.join(os.tmpdir(), "kuyacode-test-data-" + process.pid)
...
process.env["KUYACODE_TEST_HOME"] = testHome
...
const cacheDir = path.join(dir, "cache", "kuyacode")
...
process.env["KUYACODE_DISABLE_MODELS_FETCH"] = "true"
